    ...
    <div class="wrapper">
      <div id="Myform">
              <form action="form.php" method="POST">
                ...
                <label><input type="radio" name="sex_M" value="Значение1" />Мужской</label>
                <label><input type="radio" name="sex_W" value="Значение2" />Женский</label><br />
                  
                <em><strong>Колличество ваших конечностей:</strong></em><br />
                <label><input type="radio" name="Count_limbs_l2" value="Значение2" /> Менее 2</label><br />
                <label><input type="radio" name="Count_limbs_m2" value="Значение2" /> Более 2</label><br />
